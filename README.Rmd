...
and every workflow follows the same shape — **`config` + data objects → `run_*()` →
a `*_results` object.**
...
- **Guimarães, P. R. & Kimura, H.** *The Factor Zoo Revisited: Multiple Testing,
...
- **Guimarães, P. R.** *Man vs Machine: can AI-based stock-picking outperform human
