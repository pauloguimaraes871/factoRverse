...
#' @param returns_d_ref A dataframe in which columns represent tickers present in universe_m_d_ref and row represent periods
#' It should include all stocks in current_stock_universe and a dates column with at least covariance_matrix_sample_size periods before current_date
...
create_risk_parity_portfolio <- function(universe_m_d_ref, returns_upd_ref, covariance_matrix_sample_size, covariance_estimation_method, groups_m_d_ref,
  ...
  covariance_matrix <- estimate_covariance_matrix(tickers = eligible_universe_m_d_ref$tickers, returns_upd_ref = returns_upd_ref,
                                                  covariance_matrix_sample_size = covariance_matrix_sample_size,
                                                  covariance_estimation_method = covariance_estimation_method, groups_m_d_ref = groups_m_d_ref)
