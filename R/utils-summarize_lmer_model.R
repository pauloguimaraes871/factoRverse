...
summarize_lmer_model <- function(lmer_model, signal_universe_m_d_ref = NULL, signal_themes_m_d_ref, model_spec_theme_level,
  ...
  ##Join everything according to model spec
    ...
    if(model_spec_theme_level == "random_intercept_fixed_slope"){
      ...
      ##Start to join
      pooled_CAPM_metrics_m_d_ref <- signal_themes_m_d_ref %>%
