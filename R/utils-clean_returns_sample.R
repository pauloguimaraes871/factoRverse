...
#'
#' @param returns_m_xts_sample A xts in which columns represent tickers present in current_universe_df and row represent days
...
#' @param fill_by If fill is TRUE, it will fill NAs with the median of the group defined by this column. If NULL, it will use the last column of groups_m_d_ref
