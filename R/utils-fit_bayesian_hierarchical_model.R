...
#'
#' @param selected_market_factor_proxy_xts_upd_ref A numeric vector containing benchmark returns data. The vector will be recycled
...
#'   selected_backtest_returns_corrected_positions_xts_upd_ref = backtest_data,
#'   selected_market_factor_proxy_xts_upd_ref = benchmark_data,
...
#' }
#'
fit_bayesian_hierarchical_model <- function(signal_universe_m_d_ref, selected_backtest_returns_corrected_positions_xts_upd_ref, selected_market_factor_proxy_xts_upd_ref, #Data
  ...
  brm_formula <- brm_model_inputs_list$brm_formula
