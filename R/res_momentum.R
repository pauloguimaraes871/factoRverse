...
#' 
#' Calculate residual momentum based on two sets of asset returns (main and complementary), two sets of benchmark returns (main and complementary), beta, and alpha.
#' 
#' @param ret_assets_main Matrix of asset returns. Rows represent assets and columns represent time periods.
#' @param ret_assets_complementary Matrix of complementary asset returns.
#' @param ret_bench_main Matrix of benchmark returns. Rows represent benchmarks and columns represent time periods.
#' @param ret_bench_complementary Matrix of complementary benchmark returns.
#' @param beta_bench Matrix of beta values corresponding to each asset.
#' @param alpha_bench Matrix of alpha values corresponding to each asset.
#' 
