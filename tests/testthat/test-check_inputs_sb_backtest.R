...
# Define your test
test_that("check_inputs_sb_backtest throws an error for wrong cov est", {
  ...
  expect_error(
    check_inputs_sb_backtest(
      ...
      early_stop = NULL,
      target_fwd_name = "fwd_premium_1m"),
    "cov_estimation_method should be set for rp and mvo algorithms"
  )
  ...
  expect_error(
    check_inputs_sb_backtest(
      ...
      early_stop = NULL,
      target_fwd_name = "fwd_premium_1m"),
    "rp_method should be set to cyclical-spinu for rp algorithm"
  )
  ...
  expect_error(
    check_inputs_sb_backtest(
      ...
      early_stop = NULL,
      target_fwd_name = "fwd_premium_1m"),
    "n_random_ports should be numeric"
  )
  ...
  expect_error(
    check_inputs_sb_backtest(
      ...
      early_stop = NULL,
      target_fwd_name = "fwd_premium_1m"),
    "random_ports_method should be set to sample, simplex or grid"
  )
  ...
  expect_error(
    check_inputs_sb_backtest(
      ...
      early_stop = NULL,
      target_fwd_name = "fwd_premium_1m"),
    "opt_objective should be set to return, risk or sharpe"
  )
