test_that("create_performance_m_df works with no NAs and active returns", {
  ...
  #Check 1st
  expect_equal(base_signal_universe_m_d_ref$arith_mean_ret[1], -0.505126, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$geom_mean_ret[1], -0.5149917, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_ret[1], -6.007827, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$std_dev[1], 1.6192, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_std_dev[1], 5.6091, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$sharpe_ratio[1], -0.31196, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_sharpe_ratio[1], -1.0710921, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$exp_short[1], 3.1, tolerance = 1e-1) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$sharpe_ratio_exp_short[1], -0.1594, tolerance = 1e-1) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$pain[1], 0.987964, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ulcer[1], 1.34454, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_calmar_ratio[1], -2.52234, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_burke_ratio[1], -4.51, tolerance = 1e-1) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$dd_dev[1], 1.33093, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_pain_ratio[1], -6.08, tolerance = 1e-2) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$ann_martin_ratio[1], -4.4683, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$semi_dev[1], 0.9526, tolerance = 1e-2) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$down_dev[1], 1.27227, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$sortino_ratio[1], -0.39703, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$inv_d_ratio[1], 0.14485, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$down_freq[1], 0.75)
  expect_equal(base_signal_universe_m_d_ref$sharpe_ratio_semi_dev[1], -0.53, tolerance = 1e-1)
  expect_equal(base_signal_universe_m_d_ref$modigliani[1], -0.427301, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$omega[1], 0.43456, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_modigliani[1], -5.08219, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$max_dd[1], 2.3818, tolerance = 1e-3)


  #Check 2nd
  expect_equal(base_signal_universe_m_d_ref$arith_mean_ret[2], -0.8743979, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$std_dev[2], 1.2632, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_sharpe_ratio[2], -2.300906, tolerance = 1e-3)
...
test_that("create_performance_m_df works with NAs and active returns", {
  ...
  #Check 1st
  expect_equal(base_signal_universe_m_d_ref$arith_mean_ret[1], -0.414507, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$geom_mean_ret[1], -0.4339416, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_ret[1], -5.084798, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$std_dev[1], 2.7822, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_std_dev[1], 9.6380, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$sharpe_ratio[1], -0.148983, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_sharpe_ratio[1], -0.52758, tolerance = 1e-3)
  ...
  expect_equal(base_signal_universe_m_d_ref$sharpe_ratio_exp_short[1], -0.109926, tolerance = 1e-1) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$pain[1], 1.19092, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ulcer[1], 1.68422, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_calmar_ratio[1], -2.1348132, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_burke_ratio[1], -4.2696, tolerance = 1e-1) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$dd_dev[1], 1.68422, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_pain_ratio[1], -4.2696, tolerance = 1e-2) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$ann_martin_ratio[1], -3.019082, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$semi_dev[1], 1.39112, tolerance = 1e-2) #Small method difference
  expect_equal(base_signal_universe_m_d_ref$down_dev[1], 1.68422, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$sortino_ratio[1], -0.24611, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$inv_d_ratio[1], 0.651944, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$down_freq[1], 0.5)
  expect_equal(base_signal_universe_m_d_ref$sharpe_ratio_semi_dev[1], -0.2979, tolerance = 1e-1)
  expect_equal(base_signal_universe_m_d_ref$modigliani[1], -0.27914, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$omega[1], 0.651944, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_modigliani[1], -3.4242672, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$max_dd[1], 2.3818, tolerance = 1e-3)
  ...
  expect_equal(base_signal_universe_m_d_ref$std_dev[2], 1.2632, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_sharpe_ratio[2], -2.300906, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$modigliani[2], -1.052399, tolerance = 1e-3)
  expect_equal(base_signal_universe_m_d_ref$ann_modigliani[2], -12.11782, tolerance = 1e-3)
...
test_that("create_performance_m_df works with NAs and raw returns", {
  ...
  expect_equal(base_signal_universe_m_d_ref$ann_burke_ratio[1], -2.18284, tolerance = 1e-1) #Small method difference
...
test_that("create_performance_m_df works for Prob Sharpe Ratio", {
  ...
  expect_equal(result$prob_sharpe_ratio[1], as.numeric(PerformanceAnalytics::ProbSharpeRatio(A, refSR = 0)$sr_prob))
  expect_equal(result$prob_sharpe_ratio[2], as.numeric(NA))
