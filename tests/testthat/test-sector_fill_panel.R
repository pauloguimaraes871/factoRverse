...
test_that("sector_fill_panel is running correctly with 2 sectors", {
  expect_equal(
    ...
    sector_fill_panel(data.frame(
      ...
      industry_classification_column_name = c("sectors_c1"))@data),
    data.frame(
      id = (c("Stock A-2001-03-15", "Stock A-2001-04-15", "Stock A-2001-05-15",
              "Stock B-2001-03-15", "Stock B-2001-04-15", "Stock B-2001-05-15",
              "Stock C-2001-03-15", "Stock C-2001-04-15", "Stock C-2001-05-15")),
...
test_that("sector_fill_panel correctly preserves Alpha", {
  expect_equal(
    ...
    sector_fill_panel(data.frame(
      ...
      features_to_preserve = c("Alpha"))@data),
    data.frame(
      id = (c("Stock A-2001-03-15", "Stock A-2001-04-15", "Stock A-2001-05-15",
              "Stock B-2001-03-15", "Stock B-2001-04-15", "Stock B-2001-05-15",
              "Stock C-2001-03-15", "Stock C-2001-04-15", "Stock C-2001-05-15")),
...
test_that("sector_fill integrates with all other panel functions.", {
  ...
  winsorized_panel_data <- winsorize_panel_data(panel_data, c(0.975, 0.025), c("Alpha"))

  normalized_panel_data <- normalize_panel_data(winsorized_panel_data)

  industry_filled <- industry_unavaiable_feature_fill(normalized_panel_data,  unavaiable_feature = c("Delta"), similar_features = c("Alpha", "Beta"),
                                                      industry_classification_column_name = c("segment"), selected_industries = c("Intermediários financeiros"))

  sector_filled <- sector_fill_panel(industry_filled, "segment")
  ...
  expected_results <- sector_fill_panel(industry_filled, "segment")
...
# Define your test
test_that("sector_fill_panel throws an error when when features_m_df is not in right format", {
  expect_error(
...
# Define your test
test_that("sector_fill_panel throws an error when industry_classification_column is not in features_m_df", {
  expect_error(
    suppressWarnings(
    sector_fill_panel(data.frame(
      id = (c("Stock A-2001-03-15", "Stock A-2001-04-15", "Stock A-2001-05-15",
...
test_that("sector_fill integrates with external toy data - Excel Files", {
  ...
  expect_equal(sector_filled_panel@data,
               results$outputs
  )
