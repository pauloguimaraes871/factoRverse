...
- **Paulo Guimaraes**. Author, maintainer.
  [](https://orcid.org/0009-0002-2719-7731)

## Citation

Source:
[`inst/CITATION`](https://github.com/pauloguimaraes871/factoRverse/blob/main/inst/CITATION)

Guimaraes P (2026). *factoRverse: Portfolio Construction with ML-Based
and Characteristics-Based Signals*. R package version 0.4.8,
<https://github.com/pauloguimaraes871/factoRverse>.

    @Manual{,
      title = {factoRverse: Portfolio Construction with ML-Based and Characteristics-Based Signals},
      author = {Paulo Guimaraes},
      year = {2026},
      note = {R package version 0.4.8},
      url = {https://github.com/pauloguimaraes871/factoRverse},
    }
